...
namespace LfgDataTableNamespace
{
	...
	bool matchSpeciesGorax(LfgCharacterData const & lfgCharacterData, void const *, void const *, void const *, void const *, void const *)
	{
		return (lfgCharacterData.species == SharedCreatureObjectTemplate::SP_gorax);
	}
...
void LfgDataTable::install()
{
	...
	mapInternalSearchAttributeMatchFunction["gorax"] = matchSpeciesGorax;
