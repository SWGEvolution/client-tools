//======================================================================
//
// SwgCuiSpeciesSelection.h
// copyright (c) 2005 Sony Online Entertainment
//
//======================================================================

#ifndef INCLUDED_SwgCuiSpeciesSelection_H
#define INCLUDED_SwgCuiSpeciesSelection_H
...
public:
	...
	explicit SwgCuiSpeciesSelection(UIPage & page);
...
private:
	virtual                 ~SwgCuiSpeciesSelection();
	                        SwgCuiSpeciesSelection();
	                        SwgCuiSpeciesSelection(const SwgCuiSpeciesSelection & rhs);
	SwgCuiSpeciesSelection &    operator=(const SwgCuiSpeciesSelection & rhs);
